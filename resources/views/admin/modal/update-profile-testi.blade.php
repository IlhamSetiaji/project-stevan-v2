...
<div class="modal fade" tabindex="-1" role="dialog" id="updateData{{ $c->id }}">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form id="createRecord" action="{{ url('admin/profile-testi/'.$c->id.'/update') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title">Update Profile-Testi</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" class="form-control" id="name" value="{{ $c->star }}" name="star">
                    </div>
                    <div class="form-group">
                        <label>Gambar</label>
